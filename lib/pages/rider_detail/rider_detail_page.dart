          ...
          Padding(
            ...
            child: Card(
                child: Padding(
                  ...
                  child: Image.asset(
              realRiderdata.forms[index].formImage,
              width: 300.0,
              height: 300.0,
            ),
                )),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  realRiderdata.forms[index].formDescription,
                ...
                Text(
                  " - Weight: ${realRiderdata.forms[index].weight}",
                  style: TextStyle(fontSize: 18.0),
                ),
                Text(
                  " - Height: ${realRiderdata.forms[index].height}",
                  style: TextStyle(fontSize: 18.0),
                ),
                Text(
                  "Ability Parameters",
                ...
                Text(
                  "      + Punching Power: ${realRiderdata.forms[index].status.punchingPower}",
                  style: TextStyle(fontSize: 16.0),
                ),
                Text(
                  "      + Kicking Power: ${realRiderdata.forms[index].status.kickingPower}",
                  style: TextStyle(fontSize: 16.0),
                ),
                Text(
                  "      + Maximum Jumping Height: ${realRiderdata.forms[index].status.maximumJumpingHeight}",
                  style: TextStyle(fontSize: 16.0),
                ),
                Text(
                  "      + Maximum Running Speed: ${realRiderdata.forms[index].status.maximumRunningSpeed}",
                  style: TextStyle(fontSize: 16.0),
                ),
              ],
            ),
