import 'package:bladedatabase/model/customScrollBehavior.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Kamen Rider Blade Database',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      routes: {
        HomePage.routeName: (context) => const HomePage(),
        RouseCardList.routeName: (context) => const RouseCardList(),
        RiderList.routeName: (context) => const RiderList(),
        RiderDetailPage.routeName: (context) => const RiderDetailPage(),
        CardDetailPage.routeName: (context) => const CardDetailPage(),
